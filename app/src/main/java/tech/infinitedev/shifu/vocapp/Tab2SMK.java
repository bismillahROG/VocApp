...
public class Tab2SMK extends ListFragment {
    /**
     * @Override public View onCreateView(LayoutInflater inflater, ViewGroup container,
     * Bundle savedInstanceState) {
     * View rootView = inflater.inflate(R.layout.tab2smk, container, false);
     * <p>
     * return rootView;
     * }
     */
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        namaJurusan = getResources().getStringArray(R.array.jurusanSMK);
        gambar = getResources().obtainTypedArray(R.array.gambarSMK);
        deskripsi = getResources().getStringArray(R.array.deskripsiSMK);
