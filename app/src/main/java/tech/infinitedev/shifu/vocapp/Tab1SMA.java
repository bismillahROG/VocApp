...
public class Tab1SMA extends ListFragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        namaJurusan = getResources().getStringArray(R.array.jurusanSMA);
        gambar = getResources().obtainTypedArray(R.array.gambarSMA);
        deskripsi = getResources().getStringArray(R.array.deskripsiSMA);
