...
public class TesKemampuan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_submit = (Button) findViewById(R.id.submit_answers);
...
//                Context context = getApplicationContext();
                Intent pindah = new Intent(v.getContext(), HasilTes.class);
                pindah.putExtra("skor", skor);
                v.getContext().startActivity(pindah);
            }
        });
    }

    public CharSequence submitAnswers() {
        ...
        if (answer2.equalsIgnoreCase("vulcanizing")) {
            answer2_score = 1;
        } else {
            answer2_score = 0;
        }
        ...
        if (final_score == 10) {
            resultsDisplay = "Perfect! You scoredx 10 out of 10";
        } else {
